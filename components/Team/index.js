            ...
            <div className="cr-row">
              <div className="cr-col">
                ...
                <div className="team-wrapper">
                  {content.teamMember.map((teamItem, index) => {
                    return (
                          ...
                          <div className="social-contact">
                            <ul>
                              {teamItem.socialLinks &&
                                teamItem.socialLinks.map(
                                  (socialItem, index) => {
                                    let social_profile_link =
                                      socialItem.socialProfileUrl
                                        ? socialItem.socialProfileUrl.url
                                        : "#";
                                    return (
                                      <li key={index}>
                                        {socialItem.socialProfileUrl && (
                                          <a
                                            href={social_profile_link}
                                            title={socialItem.socialProfleType}
                                            target="_blank"
                                          >
                                            {socialItem.socialProfleType ==
                                              "facebook" && (
                                              <svg
                                                aria-hidden="true"
                                                focusable="false"
                                            ...
                                            {socialItem.socialProfleType ==
                                              ...
                                              <svg
                                                ...
                                                data-prefix="fab"
                                                data-icon="wordpress"
                                                className="svg-inline--fa fa-wordpress fa-w-16"
                                                role="img"
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 512 512"
                                              >
